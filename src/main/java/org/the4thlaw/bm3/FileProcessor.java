...
public class FileProcessor {
    ...
    private static final Pattern EXCLUDE_PATTERN = Pattern.compile("^BM3.Exclu(sion|de)s?.*",
    ...
    public void process(ProgressReporter reporter) throws IOException {
        Set<File> includedFiles = new TreeSet<>(); // Use a tree set to maximise cache hits for covers
     ...
     * @throws IOException
     *             If loading the playlist fails (this method does not throw exceptions if a file mentioned in a
